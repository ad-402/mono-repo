    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="terminal-card w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-accent font-sans flex items-center gap-2">
    ...
    <div className="min-h-screen bg-background py-8">
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-sans font-bold text-foreground">Submit Your Ad</h1>
          <p className="text-muted-foreground font-sans mt-2">Complete your ad submission for slot: <span className="font-mono">{params.slotId}</span></p>
        </div>

        {error && (
          <Card className="terminal-card mb-6 border-destructive/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <Card className="terminal-card">
              <CardHeader>
                <CardTitle className="font-sans text-foreground">Slot Summary</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div>
                  <label className="text-sm font-sans font-medium text-muted-foreground">Slot ID</label>
                  <p className="font-mono text-sm text-foreground">{params.slotId}</p>
                </div>
                <div>
                  <label className="text-sm font-sans font-medium text-muted-foreground">Payment Status</label>
                  <Badge variant="secondary" className="text-xs">
                    Paid via x402
                  </Badge>
                </div>
                <div>
                  <label className="text-sm font-sans font-medium text-muted-foreground">Price</label>
                  <p className="text-sm font-mono font-semibold text-foreground">$0.01 USDC</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="lg:col-span-2">
            <Card className="terminal-card">
              <CardHeader>
                <CardTitle className="font-sans text-foreground">Ad Details</CardTitle>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    {errors.advertiserWallet && (
                      <p className="text-destructive text-sm mt-1">{errors.advertiserWallet.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.contentType && (
                      <p className="text-destructive text-sm mt-1">{errors.contentType.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {errors.clickUrl && (
                      <p className="text-destructive text-sm mt-1">{errors.clickUrl.message}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      id="description"
                      className="w-full px-3 py-2 border border-border bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent"
                      rows={3}
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-border border-dashed hover:border-muted-foreground transition-colors">
